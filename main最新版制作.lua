if not getgenv().ExecutorSupport then
    loadstring(game:HttpGet("https://github.com/notpoiu/mspaint/raw/refs/heads/main/executorTest.lua"))()
end
...
local Tabs = {
    ...
    Exploits = Window:AddTab("删除绕过"),
    Visuals = Window:AddTab("绘制"),
    Floor = Window:AddTab("本楼成专属"),
...
local AutomationGroupBox = Tabs.Main:AddRightGroupbox("自动类型") do
    ...
    AutomationGroupBox:AddDropdown("AutoInteractIgnore", {
        AllowNull = true,
        Values = {"杰夫商店物品", "需要撬锁工具的", "凃漆?", "金币", "光源类型物品", "需要骷髅钥匙?"},
        Default = {"Jeff Items"},
        Multi = true,
...
local MiscGroupBox = Tabs.Main:AddRightGroupbox("杂类") do
...
local AntiEntityGroupBox = Tabs.Exploits:AddLeftGroupbox("删除-怪物") do
    ...
    AntiEntityGroupBox:AddToggle("AntiDupe", {
        Text = "删除-" .. (isBackdoor and "Vacuum" or "欺诈?"),
        Default = false
    })

    AntiEntityGroupBox:AddToggle("AntiEyes", {
        Text = "删除-" .. (isBackdoor and "Lookman" or "眼睛eyes"),
        Default = false
    })
...
MenuGroup:AddToggle("ExecuteOnTeleport", { Default = false, Text = "传送时重新执行", Visible = ExecutorSupport["queue_on_teleport"] })
MenuGroup:AddToggle("KeybindMenuOpen", { Default = false, Text = "简便菜单", Callback = function(value) Library.KeybindFrame.Visible = value end})
...
MenuGroup:AddLabel("复制类型"):AddKeyPicker("MenuKeybind", { Default = "RightShift", NoUI = true, Text = "Menu keybind" })
MenuGroup:AddButton("获得msDC", function()
...
end):AddButton("复制链接被我吃了", function()
        Library:Notify("停止幻想stop")
end)
MenuGroup:AddButton("关闭脚本", function() Library:Unload() end)

CreditsGroup:AddLabel("开发者:")
CreditsGroup:AddLabel("upio - 本脚本官方老板")
CreditsGroup:AddLabel("本脚本皆为他们开发:")
CreditsGroup:AddLabel("mstudio45")
CreditsGroup:AddLabel("bacalhauz")
CreditsGroup:AddLabel("下边的需要动UI源我懒得弄")
CreditsGroup:AddLabel("UI颜色也是要动源我懒得弄")
